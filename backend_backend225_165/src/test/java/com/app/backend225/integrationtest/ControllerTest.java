package com.app.backend225.integrationtest;
...
import com.app.backend225.SpringApp;
...
class ControllerTest {
  ...
  void  testRetrieveMetadataDocument() {
    ...
    assertNotNull(n);
    assertEquals("backend225", n.getAttribute("Namespace"));
  ...
  given()
   ...
   given()
            .when()
            .get("/backend225/Trainings?$top=1")
            .then()
    ...
    given()
            .when()
            .get("/backend225/Trainings/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  void  testCreatePerformanceAppraisalInstance() throws IOException {
    given()
        ...
        .when()
        .post("/backend225/PerformanceAppraisals")
        .then()
        .statusCode(HttpStatusCode.CREATED.getStatusCode());
  ...
  given()
   ...
   given()
            .when()
            .get("/backend225/PerformanceAppraisals?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/backend225/PerformanceAppraisals/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  given()
   ...
   given()
            .when()
            .get("/backend225/Organizations?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/backend225/Organizations/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  void  testCreateEmployeePersonalInfoInstance() throws IOException {
    given()
        ...
        .when()
        .post("/backend225/EmployeePersonalInfoes")
        .then()
        .statusCode(HttpStatusCode.CREATED.getStatusCode());
  ...
  given()
   ...
   given()
            .when()
            .get("/backend225/EmployeePersonalInfoes?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/backend225/EmployeePersonalInfoes/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  void  testCreateEmlpoyeeProfileInstance() throws IOException {
    given()
        ...
        .when()
        .post("/backend225/EmlpoyeeProfiles")
        .then()
        .statusCode(HttpStatusCode.CREATED.getStatusCode());
  ...
  given()
   ...
   given()
            .when()
            .get("/backend225/EmlpoyeeProfiles?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/backend225/EmlpoyeeProfiles/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM backend225.Training");
    jdbcTemplate.execute("DELETE FROM backend225.PerformanceAppraisal");
    jdbcTemplate.execute("DELETE FROM backend225.Organization");
    jdbcTemplate.execute("DELETE FROM backend225.EmployeePersonalInfo");
    jdbcTemplate.execute("DELETE FROM backend225.EmlpoyeeProfile");
